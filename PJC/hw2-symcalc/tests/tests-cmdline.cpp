...
//}
//
//TEST_CASE("parse_command: print with format (bonus)") {
//    SECTION("valid") {
//        using Format = Commands::Print::Format;
//        CHECK(parse_command("print") == Commands::Print{});
//        CHECK(parse_command("print:prefix") == Commands::Print{Format::Prefix});
//        CHECK(parse_command("print:postfix") == Commands::Print{Format::Postfix});
//        CHECK(parse_command("print:infix") == Commands::Print{Format::Infix});
//    }
//    SECTION("invalid") {
//        CHECK_THROWS(parse_command("print:asd"));
//    }
