...
import cz.cvut.fel.ear.meetingscheduler.security.model.AuthenticationToken;
...
public class SecurityUtils {
     ...
     *
     * @return Currently authenticated user details or null, if no one is
    ...
    /**
     * Creates an authentication token based on the specified user details and
     * sets it to the current thread's security context.
     *
    ...
    /**
     * Checks whether the current authentication token represents an anonymous
     * user.
     *
